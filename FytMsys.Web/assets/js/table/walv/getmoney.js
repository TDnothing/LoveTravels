...
var url = "/FytAdmin/FytGetMoney/", collSum = 8, tbody = $("#tables>tbody"), tdata = $("#tlist"), tb = {
    ...
    changestatus: function (id) {
        ...
        var msg = "修改记录状态后不可恢复，您确定吗？";
        dig.confim("修改状态确认", msg, function () {
            $.post(url + "ChangeStatus", { id: vals }, function (res) {
