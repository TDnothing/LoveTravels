$(function () {
    ...
    $("#Insert").click(function () {
        dig.addModel("添加/编辑菜单", url + "MenuModfiy/0", 800, 480, function () {
            tb.initTable(1);
            dig.remove();
        });
    });
    $("#Modfiy").click(function () {
        ...
        dig.addModel("添加/编辑菜单", url + "MenuModfiy/" + vals, 800, 480, function () {
            tb.initTable(1);
        });
    });
});
...
var url = "/FytAdmin/SysAdmin/", collSum = 9, tbody = $("#tables>tbody"), tdata = $("#tlist"), tb = {
                ...
                if (res.Status == "y") {
                    if (res.Data == "" || res.Data == null) {
                        ...
                        $("#tables tr").dblclick(function () {
                            ...
                            dig.addModel("添加/编辑菜单", url + "MenuModfiy/" + eId, 800, 480, function () {
                                tb.initTable(1);
                            });
                        });
                    }
    ...
    deletes: function (id) {
        ...
        dig.confim("删除确认", msg, function () {
            $.post(url + "MenuDeleteBy", { id: vals }, function (res) {
