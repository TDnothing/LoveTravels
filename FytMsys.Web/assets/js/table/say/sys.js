$(function () {
    ...
    $("#Insert").click(function () {
        dig.addModel("查看详细", url + "Modfiy/0", 650, 380, function () {
            tb.initTable(1);
            dig.remove();
        });
    });
    $("#Modfiy").click(function () {
        ...
        dig.addModel("查看详细", url + "Modfiy/" + vals, 650, 380, function () {
            tb.initTable(1);
        });
    });
});

var url = "/FytAdmin/SayMan/", collSum = 5, tbody = $("#tables>tbody"), tdata = $("#tlist"), tb = {
                ...
                if (res.Status == "y") {
                    if (res.Data == "" || res.Data == null) {
                        ...
                        $("#tables tr").dblclick(function () {
                            ...
                            dig.addModel("查看详细", url + "Modfiy/" + eId, 650, 380, function () {
                                tb.initTable(1);
                            });
                        });
                    }
