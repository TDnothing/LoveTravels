$(function () {
    ...
    $("#Insert").click(function () {
        dig.addModel("添加/编辑版本信息", url + "VersionModify/0", 800, 480, function () {
            tb.initTable(1);
            dig.remove();
        });
    });
    $("#Modfiy").click(function () {
        ...
        dig.addModel("添加/编辑版本", url + "VersionModify/" + vals, 800, 480, function () {
            tb.initTable(1);
        });
    });
});

var url = "/FytAdmin/SysBasic/", collSum = 3, tbody = $("#tables>tbody"), tdata = $("#tlist"), tb = {
                ...
                if (res.Status == "y") {
                    if (res.Data == "" || res.Data == null) {
                        ...
                        $("#tables tr").dblclick(function () {
                            ...
                            dig.addModel("添加/编辑菜单", url + "VersionModify/" + eId, 800, 480, function () {
                                tb.initTable(1);
                            });
                        });
                    }
