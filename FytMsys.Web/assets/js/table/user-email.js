$(function () {
    ...
    $("#Insert").click(function () {
        dig.addModel("添加/编辑消息模板", url + "EmailModfiy/0", 850, 500, function () {
            tb.initTable(1);
            dig.remove();
        });
    });
    $("#Modfiy").click(function () {
        ...
        dig.addModel("添加/编辑消息模板", url + "EmailModfiy/" + vals, 850, 500, function () {
            tb.initTable(1);
        });
    });
});

var url = "/FytAdmin/Member/", collSum = 6, tbody = $("#tables>tbody"), tdata = $("#tlist"), tb = {
                ...
                if (res.Status == "y") {
                    if (res.Data == "" || res.Data == null) {
                        ...
                        $("#tables tr").dblclick(function () {
                            ...
                            dig.addModel("添加/编辑消息模板", url + "EmailModfiy/" + eId, 850, 500, function () {
                                tb.initTable(1);
                            });
                        });
    ...
    deletes: function (id) {
        ...
        dig.confim("删除确认", msg, function () {
            $.post(url + "EmailDeleteBy", { id: vals }, function (res) {
