$(function () {
    ...
    $("#Modfiy").click(function () {
        ...
        dig.addModel("查看预定商品详细", url + "Modify/" + vals, 1000, 600, function () {
            tb.initTable(1);
        });
    });
});
var url = "/FytAdmin/ReturnGoodsOrder/", collSum = 10, tbody = $("#tables>tbody"), tdata = $("#tlist"), tb = {
                ...
                if (res.Status == "y") {
                    if (res.Data == "" || res.Data == null) {
                        ...
                        $("#tables tr").dblclick(function () {
                            ...
                            dig.addModel("查看预定商品详细", url + "Modify/" + eId, 1000, 600, function () {
                                tb.initTable(1);
                            });
                        });
                    }
