$(function () {
    ...
    $("#Insert").click(function () {
        dig.addModel("添加/编辑模板", url + "TempModfiy/0", 700, 400, function () {
            tb.initTable(1);
            dig.remove();
        });
    });
    $("#Modfiy").click(function () {
        ...
        dig.addModel("添加/编辑模板", url + "TempModfiy/" + vals, 700, 400, function () {
            tb.initTable(1);
        });
    });
});

var url = "/FytAdmin/SysBasic/", collSum = 6, tbody = $("#tables>tbody"), tdata = $("#tlist"), tb = {
    initTable: function (pageIndex) {
        ...
        $.ajax({
            ...
            data: { pageSize: pageSize, pageIndex: pageIndex, key: escape($("#txtKey").val()) },
                ...
                if (res.Status == "y") {
                    if (res.Data == "" || res.Data == null) {
                        ...
                        $("#tables tr").dblclick(function () {
                            ...
                            dig.addModel("添加/编辑模板", url + "TempModfiy/" + eId, 700, 400, function () {
                                tb.initTable(1);
                            });
                        });
                    }
