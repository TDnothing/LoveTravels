$(function () {
    ...
    $("#Insert").click(function () {
        dig.addModel("添加/编辑管理员", url + "AdminModfiy/0", 850, 480, function () {
            tb.initTable(1);
            dig.remove();
        });
    });
    $("#Modfiy").click(function () {
        ...
        dig.addModel("添加/编辑管理员", url + "AdminModfiy/" + vals, 850, 480, function () {
            tb.initTable(1);
        });
    });
});

var url = "/FytAdmin/SysAdmin/", collSum = 9, tbody = $("#tables>tbody"), tdata = $("#tlist"), tb = {
                ...
                if (res.Status == "y") {
                    if (res.Data == "" || res.Data == null) {
                        ...
                        $("#tables tr").dblclick(function () {
                            ...
                            dig.addModel("添加/编辑管理员", url + "AdminModfiy/" + eId, 850, 480, function () {
                                tb.initTable(1);
                            });
                        });
                    }
    ...
    deletes: function (id) {
        ...
        dig.confim("删除确认", msg, function () {
            $.post(url + "AdminDeleteBy", { id: vals }, function (res) {
