$(function () {
    ...
    $("#Insert").click(function () {
        ...
        window.location.href = url + "Modify?id=0&ClassId=" + cid;
    });
    $("#Modfiy").click(function () {
        ...
        window.location.href = url + "Modify?id=" + vals + "&ClassId=" + cid;
    });
});

var url = "/FytAdmin/Goods/", collSum = 8, tbody = $("#tables>tbody"), tdata = $("#tlist"), tb = {
            ...
            success: function (res) {
                if (res.Status == "y") {
                    if (res.Data == "" || res.Data == null) {
                        ...
                        //    dig.addModel("查看商品详细", url + "ModelDetail/" + eId, 1000, winH - 200, function () {
                        //        tb.initTable(1);
                        //    });
                        //});
                    }
