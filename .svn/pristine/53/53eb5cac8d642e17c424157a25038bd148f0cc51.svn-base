$(function () {
    ...
    $("#Insert").click(function () {
        dig.addModel("添加/编辑角色", url + "RoleModfiy/0", 700, 440, function () {
            tb.initTable(1);
            dig.remove();
        });
    });
    $("#Modfiy").click(function () {
        ...
        dig.addModel("添加/编辑角色", url + "RoleModfiy/" + vals, 700, 440, function () {
            tb.initTable(1);
        });
    });
});

var url = "/FytAdmin/SysAdmin/", collSum = 6, tbody = $("#tables>tbody"), tdata = $("#tlist"), tb = {
                ...
                if (res.Status == "y") {
                    if (res.Data == "" || res.Data == null) {
                        ...
                        $("#tables tr").dblclick(function () {
                            ...
                            dig.addModel("添加/编辑角色", url + "RoleModfiy/" + eId, 700, 440, function () {
                                tb.initTable(1);
                            });
                        });
                    }
    ...
    deletes: function (id) {
        ...
        dig.confim("删除确认", msg, function () {
            $.post(url + "RoleDeleteBy", { id: vals }, function (res) {
