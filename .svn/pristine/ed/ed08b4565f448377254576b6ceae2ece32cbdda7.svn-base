$(function () {
    ...
    $("#Insert").click(function () {
        dig.addModel("查看博主信息", url + "Modfiy/0", 800, 500, function () {
            tb.initTable(1);
            dig.remove();
        });
    });
    $("#Modfiy").click(function () {
        ...
        dig.addModel("查看博主信息", url + "Modfiy/" + vals, 800, 500, function () {
            tb.initTable(1);
        });
    });
});
                ...
                if (res.Status == "y") {
                    if (res.Data == "" || res.Data == null) {
                        ...
                        $("#tables tr").dblclick(function () {
                            ...
                            dig.addModel("查看博主信息", url + "Modfiy/" + eId, 800, 500, function () {
                                tb.initTable(1);
                            });
                        });
                    }
