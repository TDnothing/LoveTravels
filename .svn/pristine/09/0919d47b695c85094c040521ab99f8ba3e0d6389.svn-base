...
namespace upacp_sdk_net.com.unionpay.sdk
{
    ...
    public class CertUtil
    {
        ...
        {
            X509Certificate2 pc = new X509Certificate2(SDKConfig.SignCertPath, SDKConfig.SignCertPwd, X509KeyStorageFlags.MachineKeySet);//如果这行报错“系统找不到指定的文件”，请到Web,config中将sdk.signCert.path的配置项配置正确，目前仅能使用系统绝对路径。
