$(function () {
    ...
    $("#Modfiy").click(function () {
        ...
        window.location.href = url + "ColumnModfiy/" + vals + "?typeId=" + $("#typeId").val();
    });
});

var url = "/FytAdmin/Column/", collSum = 7, tbody = $("#tables>tbody"), tdata = $("#tlist"), tb = {
    initTable: function (pageIndex) {
        ...
        $.ajax({
            ...
            data: {
                pageSize: pageSize, pageIndex: pageIndex, key: escape($("#txtKey").val()),typeId:$("#typeId").val()
            },
                ...
                if (res.Status == "y") {
                    if (res.Data == "" || res.Data == null) {
                        ...
                        $("#tables tr").dblclick(function () {
                            ...
                            window.location.href = url + "ColumnModfiy/" + eId + "?typeId=" + $("#typeId").val();
                        });
                    }
                } else {
    ...
    deletes: function (id) {
        ...
        dig.confim("删除确认", msg, function () {
            $.post(url + "ColumnDeleteBy", { id: vals }, function (res) {
