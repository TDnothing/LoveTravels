$(function () {
    ...
    $("#Insert").click(function () {
        dig.addModel("第三方登录接口编辑", url + "Modfiy/0", 700, 420, function () {
            tb.initTable(1);
            dig.remove();
        });
    });
    $("#Modfiy").click(function () {
        ...
        dig.addModel("第三方登录接口编辑", url + "Modfiy/" + vals, 700, 420, function () {
            tb.initTable(1);
        });
    });
});

var url = "/FytAdmin/LoginApi/", collSum = 9, tbody = $("#tables>tbody"), tdata = $("#tlist"), tb = {
                ...
                if (res.Status == "y") {
                    if (res.Data == "" || res.Data == null) {
                        ...
                        $("#tables tr").dblclick(function () {
                            ...
                            dig.addModel("第三方登录接口编辑", url + "Modfiy/" + eId, 700, 420, function () {
                                tb.initTable(1);
                            });
                        });
                    }
