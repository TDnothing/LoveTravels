$(function () {
    ...
    $("#Modfiy").click(function () {
        ...
        window.location.href = url + "DownLoadModfiy/" + vals + "?ClassId=" + $("#ClassId").val();
    });
});

var url = "/FytAdmin/DownLoad/", collSum = 7, tbody = $("#tables>tbody"), tdata = $("#tlist"), tb = {
                ...
                if (res.Status == "y") {
                    if (res.Data == "" || res.Data == null) {
                        ...
                        $("#tables tr").dblclick(function () {
                            ...
                            window.location.href = url + "DownLoadModfiy/" + eId + "?ClassId=" + $("#ClassId").val();
                        });
                    }
                } else {
